...
public class CRUDGenerator {
    ...
    //private static final String UPDATE= " update student set FirstName=?  LastName=? FullName=?" +
    //            " where  studentID =? ";
    public void update(Object object, int id) throws IOException, IllegalAccessException, SQLException {
        DBConnection dbConnection = DBConnection.getInstance();
        Connection connection = dbConnection.getConnection();
        Table table = object.getClass().getDeclaredAnnotation(Table.class);
    ...
    public void delete(int id, Object object) throws IOException, SQLException {

        DBConnection dbConnection = DBConnection.getInstance();
        Connection connection = dbConnection.getConnection();

        Table table = object.getClass().getAnnotation(Table.class);
        String query = " delete from " + table.name() + " where ID=" + id;
